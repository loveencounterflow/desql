(function() {
  ...
  ( 'window_frame',                       'wf'        ),
  ( 'window_ref',                         'wr'        );`);
        ref = ['a create view', 'a select', 'a from', 'i function name', 'i join on col name', 'i join on tbl alias', 'i join on tbl name', 'i order by col name', 'i order by tbl name', 'i other', 'i from col alias', 'i from', 'i col', 'i tbl', 'i alias', 'i name', 'k generated always as', 'k generated always', 'k generated', 'k insert into', 'k insert', 'k join on', 'k join using', 'k join', 'k order by ascending', 'k order by descending', 'k order by', 'k order', 'k from', 'k select', 'k where', 'k window as', 'k window', 'k with', 'l other', 's bracket round left', 's bracket round right', 's colon', 's comma', 's dot', 's o-perator', 's semi-colon', 's spc'];
        //...................................................................................................
        /* areas */
        //...................................................................................................
        /* identifiers */
        ...
        ref2 = [['a create view', '-cview-'], ['a from', '-from-'], ['a select', '-select-'], ['i alias', '-tn-ta-[uq]i-t'], ['i col', '-ve-cref-i-[uq]i-t$'], ['i col', '-dref-i-[uq]i-t$'], ['i name', '-ve-cref-i-[uq]i-t$'], ['i from', '-s-.*-from-.*-i-[uq]i-t$'], ['i function name', '-fc-fn-qn-i-[uq]i-t$'], ['i name', '-cview-mi-eci-i-[uq]i-t$'], ['i name', '-tn-.*-i-[uq]i-t$'], ['i tbl', '-cview-mi-eci-i-[uq]i-t$'], ['i tbl', '-tn-.*-i-[uq]i-t$'], ['i tbl', '-tn-ta-[uq]i-t'], ['i tbl', '-dref-cref-i-[uq]i-t'], ['l other', '-c-.*-t$'], ['s dot', '-ve-dref-t$']];
        //.....................................................................................................
        //.....................................................................................................
        // [ 'i other',          '-[uq]i-t$',                        ]
        //.....................................................................................................
