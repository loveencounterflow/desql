(function() {
  ...
  ( 'window_frame',                       'wf'        ),
  ( 'window_ref',                         'wr'        );`);
        ref = ['i function name', 'i join on col name', 'i join on tbl alias', 'i join on tbl name', 'i order by col name', 'i order by tbl name', 'i other', 'i select from col alias', 'i select from tbl alias', 'i select from', 'i tbl name', 'i col name', 'k generated always as', 'k generated always', 'k generated', 'k insert into', 'k insert', 'k join on', 'k join using', 'k join', 'k order by ascending', 'k order by descending', 'k order by', 'k order', 'k select from', 'k select', 'k where', 'k window as', 'k window', 'k with', 'l other', 'r create view', 's bracket round left', 's bracket round right', 's colon', 's comma', 's dot', 's o-perator', 's semi-colon', 's spc'];
        ...
        ref2 = [['i function name', '-fc-fn-qn-i-[uq]i-t$'], ['i other', '-i-[uq]i-t$'], ['l other', '-c-.*-t$'], ['r create view', '-cv-'], ['i select from', '-s-.*-from-.*-i-[uq]i-t$'], ['k select from', '-s-.*-from-t$'], ['k select', '-s-.*-select-t$'], ['i tbl name', '-tn-.*-i-[uq]i-t$'], ['i col name', '-ve-cref-i-[uq]i-t$'], ['s dot', '-ve-dref-t$']];
        //.......................................................................................................
