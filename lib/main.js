(function() {
  ...
  ( 'window_frame',                       'wf'        ),
  ( 'window_ref',                         'wr'        );`);
        ref = ['a create view', 'a select', 'a from', 'i function name', 'i col', 'i tbl', 'i alias', 'i real name', 'k generated always as', 'k generated always', 'k generated', 'k insert into', 'k insert', 'k join on', 'k join using', 'k join', 'k order by ascending', 'k order by descending', 'k order by', 'k order', 'k from', 'k select', 'k where', 'k window as', 'k window', 'k with', 'l other', 's bracket round left', 's bracket round right', 's colon', 's comma', 's dot', 's o-perator', 's semi-colon', 's spc'];
        //...................................................................................................
        /* areas */
        //...................................................................................................
        /* identifiers */
        ...
        ref2 = [['a create view', '-cview-'], ['a from', '-from-'], ['a select', '-select-'], ['i alias', '-tn-ta-[uq]i-t'], ['i col', '-ve-cref-i-[uq]i-t$'], ['i col', '-dref-i-[uq]i-t$'], ['i col', '-ne-eci-i-[uq]i-t$'], ['i alias', '-ne-eci-i-[uq]i-t$'], ['i real name', '-ve-cref-i-[uq]i-t$'], ['i function name', '-fc-fn-qn-i-[uq]i-t$'], ['i real name', '-cview-mi-eci-i-[uq]i-t$'], ['i real name', '-tn-.*-i-[uq]i-t$'], ['i real name', '-ve-dref-i-[uq]i-t$'], ['i tbl', '-cview-mi-eci-i-[uq]i-t$'], ['i tbl', '-tn-.*-i-[uq]i-t$'], ['i tbl', '-tn-ta-[uq]i-t'], ['i tbl', '-dref-cref-i-[uq]i-t'], ['k from', '-from-t$'], ['k select', '-select-t$'], ['l other', '-c-.*-t$'], ['s dot', '-ve-dref-t$']];
        //.....................................................................................................
        //.....................................................................................................
        // [ 'i other',        '-[uq]i-t$',                        ]
        //.....................................................................................................
