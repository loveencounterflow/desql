(function() {
  ...
  this.Desql = (function() {
    class Desql {
      ...
      //---------------------------------------------------------------------------------------------------------
      _procure_infradata() {
        this.db(SQL`insert into types ( name, short ) values
  -- .................................................................................................
  ( 'spc',                                'spc'       ),
  ( 'miss',                               'miss'      ),
  ( 'start',                              'start'     ),
  ...
  ( 'window_ref',                         'wr'        );`);
      ...
      _procure_infrastructure() {
        ...
        //.......................................................................................................
        this.db(SQL`create table types (
...
union all select
  ...
  returning *;`)
      ...
      _build_tree(qid, query, antlr, parent, tree) {
        var branch, flat_node, i, len, node, path, pathsep, position, ref, ref1, ref2, ref3, short_type, tdbfn, txt, type, upid;
        tdbfn = this.constructor.C.typedata.by_full_name;
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          short_type = (ref2 = (ref3 = tdbfn[type]) != null ? ref3.t2 : void 0) != null ? ref2 : type;
          path = parent != null ? parent.path + pathsep + short_type : pathsep + short_type;
    ...
    Desql.C = GUY.lft.freeze({
      ...
      typedata: {
        by_full_name: {
          ...
          quoted_identifier_alternative: {
            t2: 'qia'
          },
          regular_query_specification: {
            t2: 'rqs'
          },
          relation: {
            t2: 'r'
