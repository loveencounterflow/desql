(function() {
  'use strict';
  var ANTLR, CND, DBay, DBay_trash, GUY, SQL, badge, debug, echo, help, info, rpr, to_snake_case, types, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.Desql = (function() {
    class Desql extends DBay_trash() {
      //---------------------------------------------------------------------------------------------------------
      constructor(...P) {
        super();
        if (P.length > 0) {
      ...
      //---------------------------------------------------------------------------------------------------------
      _procure_infradata() {
        var code, error, i, j, len, len1, matcher, name, ref, ref1, ref2;
        this.db(SQL`insert into ntypes ( name, short ) values
  -- .................................................................................................
  ( 'spc',                                'spc'       ),
  ( 'miss',                               'miss'      ),
  ( 'start',                              'start'     ),
  ...
  ( 'window_frame',                       'wf'        ),
  ( 'window_ref',                         'wr'        );`);
        ref = ['a create table', 'a create view', 'a select', 'a from', 'a join', 'i function name', 'i col', 'i tbl', 'i alias', 'i real name', 'k generated always as', 'k generated always', 'k generated', 'k insert into', 'k insert', 'k join on', 'k join using', 'k join', 'k order by ascending', 'k order by descending', 'k order by', 'k order', 'k from', 'k select', 'k where', 'k window as', 'k window', 'k with', 'k type', 'l other', 's bracket round left', 's bracket round right', 's colon', 's comma', 's dot', 's o-perator', 's semi-colon', 's spc'];
        //...................................................................................................
        /* areas */
        //...................................................................................................
        /* identifiers */
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          name = ref[i];
          ({code, name} = this._code_and_name_from_tcat_name(name));
          try {
            this.db(SQL`insert into tcats ( code, name ) values ( $code, $name )`, {code, name});
          } catch (error1) {
            error = error1;
            debug(error.name);
            if ((ref1 = error.code) !== 'SQLITE_CONSTRAINT_UNIQUE' && ref1 !== 'SQLITE_CONSTRAINT_PRIMARYKEY') {
              throw error;
            }
            throw new Error(`^desql/_procure_infradata@1^ tcat code: ${rpr(code)} (name: ${rpr(name)}) is not unique`);
          }
        }
        ref2 = [['a create view', '-cview-'], ['a create table', '-tview-'], ['a from', '-from-'], ['a select', '-select-'], ['a join', '-jr-'], ['i alias', '-tn-ta-(ui|qia-qi)(-ansinr)?-t'], ['i col', '-ve-cref-i-(ui|qia-qi)(-ansinr)?-t$'], ['i col', '-dref-i-(ui|qia-qi)(-ansinr)?-t$'], ['i col', '-ne-eci-i-(ui|qia-qi)(-ansinr)?-t$'], ['i col', '-is-eci-i-(ui|qia-qi)(-ansinr)?-t$'], ['i col', '-ctable-cltl-clt-eci-i-(ui|qia-qi)(-ansinr)?-t$'], ['i alias', '-ne-eci-i-(ui|qia-qi)(-ansinr)?-t$'], ['i real name', '-ve-cref-i-(ui|qia-qi)(-ansinr)?-t$'], ['i function name', '-fc-fn-qn-i-(ui|qia-qi)(-ansinr)?-t$'], ['i real name', '-cview-mi-eci-i-(ui|qia-qi)(-ansinr)?-t$'], ['i real name', '-tn-.*-i-(ui|qia-qi)(-ansinr)?-t$'], ['i real name', '-ve-dref-i-(ui|qia-qi)(-ansinr)?-t$'], ['i tbl', '-cview-mi-eci-i-(ui|qia-qi)(-ansinr)?-t$'], ['i tbl', '-ctable-ctableh-mi-eci-i-(ui|qia-qi)(-ansinr)?-t$'], ['i tbl', '-tn-.*-i-(ui|qia-qi)(-ansinr)?-t$'], ['i tbl', '-tn-ta-(ui|qia-qi)(-ansinr)?-t'], ['i tbl', '-dref-cref-i-(ui|qia-qi)(-ansinr)?-t'], ['k from', '-from-t$'], ['k select', '-select-t$'], ['k where', '-where-t$'], ['k type', '-ctable-cltl-clt-pdt-i-(ui|qia-qi)(-ansinr)?-t'], ['l other', '-c-.*-t$'], ['s dot', '-ve-dref-t$']];
        //.....................................................................................................
        //.....................................................................................................
        // [ 'i other',          '-(ui|qia-qi)-t$',                        ]
        //.....................................................................................................
        ...
        for (j = 0, len1 = ref2.length; j < len1; j++) {
          ...
          //.....................................................................................................
          ({code, name} = this._code_and_name_from_tcat_name(name));
          if ((this.db.single_value(SQL`select count(*) from tcats where code = $code`, {code})) === 0) {
            code = `x${code}`;
            name = `x ${name}`;
            this.db(SQL`insert into tcats ( code, name ) values ( $code, $name )`, {code, name});
          }
          this.db(SQL`insert into tcat_rules ( code, matcher ) values ( $code, $matcher );`, {code, matcher});
        }
        //.......................................................................................................
        return null;
      }
      ...
      _procure_infrastructure() {
        ...
        pathsep_lit = this.db.sql.L(this.constructor.C.pathsep);
        //.......................................................................................................
        this.db(SQL`create table ntypes ( -- node types
    name    text not null primary key,
    short   text not null unique );`);
        //.......................................................................................................
        this.db(SQL`create table tcats ( -- terminal category codes
    code    text not null primary key,
    name    text not null unique );`);
        //.......................................................................................................
        this.db(SQL`create table tcat_rules (
  ...
  check ( type = 're' ) );`);
        //.......................................................................................................
        this.db(SQL`create view tcat_matches as select
    nd.qid    as qid,
    nd.id     as id,
    nd.xtra   as xtra,
    tc.code   as code,
...
union all select
  ...
  order by qid, pos1;`);
        //.......................................................................................................
        this.db(SQL`create view nodes as select
    *,
    null as txt
  from raw_nodes
  where pos1 is null
union all select
  ...
  order by qid, id, xtra;`);
        //.......................................................................................................
        this.db(SQL`create view terminals_with_grouped_tags as select distinct
    n.path                                as path,
    n.pos1                                as pos1,
    n.type                                as type,
    n.txt                                 as txt,
  ...
  order by n.pos1;`);
      ...
      _compile_sql() {
        ...
        GUY.props.hide(this, 'statements', {
          ...
          //.....................................................................................................
          insert_regular_node: this.db.prepare(SQL`insert into raw_nodes ( qid, id, upid, type, path, pos1, pos2, lnr1, col1, lnr2, col2 )
  with
  ...
  returning *;`),
          //.....................................................................................................
          insert_start_node: this.db.prepare(SQL`insert into raw_nodes ( qid, id, xtra, upid, type, path, pos1, pos2, lnr1, col1, lnr2, col2 )
  values (
    $qid, 1, 1, null, 'start', 'start', 1, 0, 0, 0, 0, 0 )
  returning *;`),
          //.....................................................................................................
          insert_stop_node: this.db.prepare(SQL`insert into raw_nodes ( qid, id, xtra, upid, type, path, pos1, pos2, lnr1, col1, lnr2, col2 )
  values (
    $qid,
    ( select coalesce( max( id ), 0 ) + 1 as id from raw_nodes ),
    1, null, 'stop', 'stop',
  ...
  returning *;`)
      ...
      parse(query) {
        ...
        this._build_tree(qid, query, antlr, null, R);
      ...
      _build_tree(qid, query, antlr, parent, tree) {
        var branch, flat_node, i, len, node, pathsep, position, ref, ref1, txt, type, upid;
        pathsep = this.constructor.C.pathsep;
        ref = antlr.children;
        for (i = 0, len = ref.length; i < len; i++) {
          branch = ref[i];
          ...
          if (branch.children != null) {
            this._build_tree(qid, query, branch, flat_node, node);
          }
