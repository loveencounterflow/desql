(function() {
  'use strict';
  var CND, GUY, SQL, X, _show_antler_tree, antler_types, badge, debug, echo, equals, help, info, isa, queries, rpr, show_antler_tree, show_overview, tabulate, to_snake_case, type_of, type_of_antler_node, types, urge, validate, validate_list_of, warn, whisper, xrpr;
...
select 'helo world' as greetings;`,
  ...
  //-----------------------------------------------------------------------------------------------------------
  _show_antler_tree = function(tree, parent, level, R) {
    var dent, i, id, len, node, ref, type, type_entry, type_entry_type;
    dent = '  '.repeat(level);
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (false) {
        (() => {
          var k, ref1, ref2, ref3, ref4, ref5, v;
          whisper('^5600-2^', '------------------------------------------------------------');
          for (k in node) {
            v = node[k];
          ...
          if (node._start != null) {
            info('^5600-4^', "node._start?.index", (ref1 = node._start) != null ? ref1.index : void 0);
            info('^5600-5^', "node._start?._line", (ref2 = node._start) != null ? ref2._line : void 0);
            info('^5600-6^', "node._start?._charPositionInLine", (ref3 = node._start) != null ? ref3._charPositionInLine : void 0);
            info('^5600-7^', "node._stop?._line", (ref4 = node._stop) != null ? ref4._line : void 0);
            info('^5600-8^', "node._stop?._charPositionInLine", (ref5 = node._stop) != null ? ref5._charPositionInLine : void 0);
          }
  ...
  antler_types = {
    ...
    select_clause: function(node) {
      var col, idx1, idx2, lnr, terminal, text, type;
