  ...
  this.DBay_trash = (clasz = Object) => {
    return class extends clasz {
      ...
      trash_to_sql(cfg) {
        ...
        this.setv('_use_dot_cmds', cfg._use_dot_cmds);
        ({path, overwrite} = cfg);
        iterator = this.query(this._trash_select_from_statements);
      ...
      trash_to_sqlite(cfg) {
        ...
        sqlt = this.constructor.new_bsqlt3_connection();
        sqlt.exec(sql);
      ...
      _trash_get_path(path, extension) {
        ...
        return PATH.join(clasz.C.autolocation, this.rnd.get_random_filename(extension));
      }
